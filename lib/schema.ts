...
import type { PgBaseSchema, VARCHAR50_PG, BIGINT_PG, VARCHAR_PG, StreamLog, SMALLINT_PG, INTEGER_PG } from "qqlx-core";
...
export class IdBase implements PgBaseSchema {
    // =============================
    // ======= 必须有的字段 ========
    // =============================
...
export class UuidBase implements PgBaseSchema {
